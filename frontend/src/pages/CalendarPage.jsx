...
export default function CalendarPage() {
  ...
  return (
    <div className="page-padding space-y-4 animate-fade-in lg:flex lg:items-start lg:gap-6 lg:space-y-0">
      <div className="space-y-4 lg:w-full lg:max-w-md lg:shrink-0">
        <header>
