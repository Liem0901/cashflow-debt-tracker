        ...
        {transactions.map((tx) => {
          ...
          return (
            <button
              ...
              className={`flex w-full items-center justify-between rounded-xl border border-portfolio-border bg-portfolio-elevated px-3 py-2.5 text-left transition-colors ${editable ? 'hover:border-white active:bg-portfolio-muted' : ''
                }`}
            >
              <div className="flex items-center gap-3">
                <span
                  className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-lg ${isIncome ? 'bg-metric-cash/15 text-metric-cash' : 'bg-portfolio-muted'
                    }`}
                >
              ...
              <div className="shrink-0 text-right">
                <p
                  className={`text-amount font-semibold ${isIncome ? 'text-metric-cash' : 'text-white'
                    }`}
                >
                  {isIncome ? '+' : ''}
